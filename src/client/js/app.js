...
function getZoneColor(cell, real) {
    switch (cell) {
      case 'bas1': case "dom1": return color.blue; 
      case 'bas2': case "dom2": return color.green; 
      case 'bas3': case "dom3": return color.red; 
      case 'bas4': case "dom4": return color.pink; 
      case "dom0": return color.gold;
